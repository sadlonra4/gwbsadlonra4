  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 100, 0, 0.8), rgba(0, 0, 0, 0.9)), url('https://images.unsplash.com/photo-1605810230434-7631ac76ec81?q=80&w=6052&auto=format&fit=crop')`,
        }}
      />
